...
public class Target_making : MonoBehaviour
{
	...
	A:		if(countt>=100)
			...
			foreach (GameObject gameo in targetz)
			{
				...
				(gameo.GetComponentInChildren<Renderer>().bounds.size.y/2+target_normal.GetComponentInChildren<Renderer>().bounds.size.x/2)
				*(gameo.GetComponentInChildren<Renderer>().bounds.size.y/2+target_normal.GetComponentInChildren<Renderer>().bounds.size.x/2))
				{
					countt++;
...
A:		if(countt>=100)
			...
			{
				if((gameo.transform.position-new Vector3(temp_x,temp_y,temp_z)).sqrMagnitude<
				(gameo.GetComponentInChildren<Renderer>().bounds.size.y/2+target_hard.GetComponentInChildren<Renderer>().bounds.size.x/2)*
				(gameo.GetComponentInChildren<Renderer>().bounds.size.y/2+target_hard.GetComponentInChildren<Renderer>().bounds.size.x/2))
				{
					countt++;
					goto A;    //近すぎる場合は破棄し、再生成する
	...
	A:		if(countt>=100)
			...
			if(wall==1)
			{
				temp_x = Random.Range(-24.5f+target_small.GetComponentInChildren<Renderer>().bounds.size.x/2,24.5f-target_small.GetComponentInChildren<Renderer>().bounds.size.x/2);
				temp_y = Random.Range(target_small.GetComponentInChildren<Renderer>().bounds.size.x/2,50-target_small.GetComponentInChildren<Renderer>().bounds.size.x/2);
				temp_z = 24.5f-target_small.GetComponentInChildren<Renderer>().bounds.size.z;
			}
			else if(wall==2)
			{
				temp_x = Random.Range(-24.5f+target_small.GetComponentInChildren<Renderer>().bounds.size.x/2,24.5f-target_small.GetComponentInChildren<Renderer>().bounds.size.x/2);
				temp_y = Random.Range(target_small.GetComponentInChildren<Renderer>().bounds.size.x/2,50-target_small.GetComponentInChildren<Renderer>().bounds.size.x/2);
				temp_z = target_small.GetComponentInChildren<Renderer>().bounds.size.z-24.5f;
			}
			else if(wall==3)
			{
				temp_x = target_small.GetComponentInChildren<Renderer>().bounds.size.z-24.5f;
				temp_y = Random.Range(target_small.GetComponentInChildren<Renderer>().bounds.size.x/2,50-target_small.GetComponentInChildren<Renderer>().bounds.size.x/2);
				temp_z = Random.Range(-24.5f+target_small.GetComponentInChildren<Renderer>().bounds.size.x/2,24.5f-target_small.GetComponentInChildren<Renderer>().bounds.size.x/2);
			}
			else if(wall==4)
			{
				temp_x = 24.5f-target_small.GetComponentInChildren<Renderer>().bounds.size.z;
				temp_y = Random.Range(target_small.GetComponentInChildren<Renderer>().bounds.size.x/2,50-target_small.GetComponentInChildren<Renderer>().bounds.size.x/2);
				temp_z = Random.Range(-24.5f+target_small.GetComponentInChildren<Renderer>().bounds.size.x/2,24.5f-target_small.GetComponentInChildren<Renderer>().bounds.size.x/2);
			}
			if(Debug==true)
			...
			{
				if((gameo.transform.position-new Vector3(temp_x,temp_y,temp_z)).sqrMagnitude<
				(gameo.GetComponentInChildren<Renderer>().bounds.size.y/2+target_small.GetComponentInChildren<Renderer>().bounds.size.x/2)
				*(gameo.GetComponentInChildren<Renderer>().bounds.size.y/2+target_small.GetComponentInChildren<Renderer>().bounds.size.x/2))
				{
					countt++;
					goto A;    //近すぎる場合は破棄し、再生成する
